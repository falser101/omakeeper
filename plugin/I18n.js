...
var EN = {
  ...
  "cat.packages.hint": "AUR helper caches; pacman pkg cache stays off until you select it",
  ...
  "cat.flatpak.hint": "App caches; unused runtimes stay off until you select them",
  "cat.leftovers.title": "Leftovers",
  "cat.leftovers.hint": "Folders left after uninstalling apps · off by default",
  "cat.downloads.title": "Old downloads",
  "cat.downloads.hint": "Large or incomplete files in Downloads older than 30 days · off by default",
  ...
  "clean.scanHint": "Tap Scan below, or tap the cat to sprint",
...
var ZH = {
  ...
  "cat.packages.hint": "AUR 助手缓存；pacman 包缓存默认不勾选",
  "cat.apps.title": "应用缓存",
  "cat.apps.hint": "应用临时文件，下次启动会重新生成",
  "cat.logs.title": "日志",
  "cat.logs.hint": "诊断日志。占用中的文件会跳过",
  "cat.flatpak.title": "Flatpak",
  "cat.flatpak.hint": "应用缓存；未使用的 runtime 默认不勾选",
  "cat.leftovers.title": "卸载残留",
  "cat.leftovers.hint": "软件卸载后留下的目录 · 默认不勾选",
  "cat.downloads.title": "旧下载",
  "cat.downloads.hint": "Downloads 里超过 30 天的大文件或未下完的文件 · 默认不勾选",
  "cat.other.title": "其他",
